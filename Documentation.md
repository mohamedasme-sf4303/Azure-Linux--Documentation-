---
layout: post
title: Installing and Enabling Backup Compatibility for Bold BI on Azure Linux VM | Documentation
description: Learn how to install Bold BI on Azure Linux VM instance and enable backup compatibility with easy-to-follow steps. Ensure data protection and disaster recovery for your Bold BI installation.
platform: bold-bi
documentation: ug
---
